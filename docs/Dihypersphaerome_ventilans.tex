...
%  Replete AI · Genesis Artificial Life Laboratory
%  Teármann Research Ecosystem · Internal Report · April 2026
%
...
\fancyhead[R]{\sffamily\footnotesize\textcolor{muted}{\textsc{Teármann Internal · 2026}}}
...
\begin{center}
  {\sffamily\footnotesize\textcolor{muted}{\textsc{Teármann Research Ecosystem \,\textperiodcentered\, Internal Technical Report}}}\\[3pt]
  {\sffamily\footnotesize\textcolor{muted}{\textsc{Genesis Artificial Life Laboratory}}}\\[28pt]
  ...
  {\sffamily\small\textcolor{muted}{Replete AI \,\textperiodcentered\, Genesis Artificial Life Laboratory}}\\[2pt]
  {\sffamily\small\textcolor{muted}{Teármann Research Ecosystem}}\\[18pt]
...
{\sffamily\footnotesize\color{muted}
  ...
  code 3\textsc{Hy}2v \,\textperiodcentered\, Teármann 2026}
\end{center}
...
\bibitem[Koons \& Claude(2026){Koons and Claude}]{koons2026}
Sebastian, S.\ \& Claude (2026).
\newblock \textit{Orbium unicaudatus ignis var.\ phantasma}: A Lenia
  Species Engineered to Inhabit the Edge of Chaos. Replete AI internal
  report.
...
\begin{center}
\sffamily\footnotesize\color{muted}
Genesis Artificial Life Laboratory \,\textperiodcentered\, Replete AI \,\textperiodcentered\, Teármann Research Ecosystem \,\textperiodcentered\, 2026\\
\href{https://github.com/Kquant03/genesis-phase-transition}{\texttt{github.com/Kquant03/genesis-phase-transition}} \,\textperiodcentered\, \href{https://repleteai.com}{\texttt{repleteai.com}}
\end{center}
